...
class Pager {
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator .= "<li><a title=\"Primeira Página\" href=\"{$this->Link}1{$this->Hash}\">{$this->First}</a></li>";
            ...
            $this->Paginator .= "<li><a title=\"Última Página\" href=\"{$this->Link}{$Paginas}{$this->Hash}\">{$this->Last}</a></li>";
            $this->Paginator .= "</ul>";
        endif;
    }
