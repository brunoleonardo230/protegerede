...
/**
 * Seo [ MODEL ]
 * Classe de apoio para o modelo LINK. Pode ser utilizada para gerar SEO para as pÃ¡ginas do sistema!
 * 
...
class Seo {
    ...
    private function setPach() {
        ...
        elseif ($this->File == 'artigos'):
            //ARTIGOS
            $this->Schema = 'WebSite';
            $this->Title = "Blog - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'categorias'):
            //ARTIGOS
        ...
        elseif ($this->File == 'conta'):
            ...
            if (ACC_MANAGER):
                ...
                $this->Schema = 'WebSite';
                $this->Title = (!empty($ArrAccountApp[$this->Link]) ? SITE_NAME . " - " . $ArrAccountApp[$this->Link] : 'OPSSS!');
                $this->Description = SITE_DESC;
                $this->Image = INCLUDE_PATH . '/images/default.jpg';
            else:
                $this->set404();
        ...
        elseif ($this->File == 'imoveis'):
            ...
            $this->Schema = 'WebSite';
            $this->Title = $Link . "ImÃ³veis - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'filtro'):
            //FILTRO
            $this->Schema = 'WebSite';
            $this->Title = "Filtrar ImÃ³veis - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        ...
        elseif ($this->File == 'especialidades'):
            //ESPECIALIDADES
            $this->Schema = 'WebSite';
            $this->Title = "Especialidades - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'medico'):
            //MÉDICO
            $Read->FullRead("SELECT doctor_name, doctor_content, doctor_cover FROM " . DB_DOCTORS . " WHERE doctor_url = :nm AND doctor_datecreate <= NOW()", "nm={$this->Link}");
            if ($Read->getResult()):
                $Doctors = $Read->getResult()[0];
                $this->Schema = 'WebSite';
                $this->Title = $Doctors['doctor_name'] . " - " . SITE_NAME;
                $this->Description = Check::Words($Doctors['doctor_content'], 15);
                $this->Image = BASE . "/uploads/{$Doctors['doctor_cover']}";
            else:
                $this->set404();
            endif;
        elseif ($this->File == 'medicos'):
            //MÉDICOS
            $this->Schema = 'WebSite';
            $this->Title = "Médicos - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';    
        elseif ($this->File == 'sobre'):
            //SOBRE
            $this->Schema = 'WebSite';
            $this->Title = "Sobre " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'servicos'):
            ...
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'galeria'):
            //GALERIA
            $this->Schema = 'WebSite';
            $this->Title = "Galeria - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';  
