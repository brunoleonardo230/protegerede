...
if ($PostData && $PostData['callback_action'] && $PostData['callback'] == $CallBack):
    ...
    switch ($Case):
        ...
        case 'manager':
            ...
            $jSON['plugin'] = true;
            $jSON['alert'] = ["green", "checkmark", "TUDO CERTO", "O Imóvel <b>{$PostData['realty_title']}</b> Foi Atualizado Com Sucesso No Sistema!"];
        ...
        case 'delete':
            ...
            $jSON['success'] = true;
            $jSON['alert'] = ["green", "checkmark", "TUDO CERTO {$_SESSION['userLogin']['user_name']}", "O Imóvel Foi Excluído Com Sucesso!"];
            $jSON['redirect'] = "dashboard.php?wc=imobi/home";
            break;
    endswitch;
