$(document).ready(function () {
    ...
    $('html').on('click', '.js-user-toggle', function (e) {
        ...
        if (checked == 1) {
            ...
            count.html(checked + '/' + total.val() + ' Médicos Selecionados');
        } else {
            count.html('Selecione o(s) Médico(s)');
        }
    });
    ...
    $('html').on('click', '.js-modal-mark', function (e) {
        ...
        count.html(total.val() + '/' + total.val() + ' Médicos Selecionados');
        value.val('all');
    });
    ...
    $('html').on('keyup', '.js-marketing-search', function () {
        ...
        $.post('_ajax/Doctors.ajax.php', data, function (data) {
