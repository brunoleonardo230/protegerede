...
if (!file_exists(__DIR__ . "/../dashboard.json")):
    $LicenseCheckMail = "<p style='font-size: 0.8rem; color: red;'>ATENÇÃO: Essa Versão do Work Control® Não Foi Licenciada. Utilizar Esse Software Sem Licença é Crime. Entre Em Contato Via cursos@upinside.com.br Para Maiores Esclarecimentos!</p>";
else:
