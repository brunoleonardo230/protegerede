...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <form name="searchPosts" action="" method="post" enctype="multipart/form-data" class="ajax_off">
            ...
            <button class="btn_header btn_aquablue icon icon-search icon-notext"></button>
        </form>
    </div>
</header>
                ...
                foreach ($Read->getResult() as $Search):
                    ...
                    echo "
                        <article>
                           ...
                           <p>
                                    <button class='btn_header btn_darkaquablue icon-notext icon-checkmark wc_tooltip j_wc_action' data-callback='Search' data-callback-action='publish' data-value='$search_id'><span class='wc_tooltip_balloon'>Publicar</span></button>
                                    <button class='btn_header btn_red icon-notext icon-cross wc_tooltip j_wc_action' data-callback='Search' data-callback-action='delete' data-value='$search_id'><span class='wc_tooltip_balloon'>Deletar</span></button>
                            </p>
                        </article>
                        ";
                endforeach;
