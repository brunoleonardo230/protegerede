        ...
        foreach ($Read->getResult() as $REALTY):
            ...
            echo "<article class='box box25 imobi_single' id='{$realty_id}'>           
                ...
                <div class='box_actions'>
                    ...
                    <span title='Excluir Imóvel' rel='imobi_single' callback='Properties' callback_action='delete' class='j_delete_action icon-cancel-circle btn btn_red' id='{$realty_id}'>Excluir</span>
                </div>
            </article>";
        endforeach;
