...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        echo Erro("<span class='al_center icon-notification'>Olá {$Admin['user_name']}, Ainda Não Existem Imóveis Cadastrados. Comece Agora Mesmo Cadastrando Seu Primeiro Imóvel!</span>", E_USER_NOTICE);
    else:
        foreach ($Read->getResult() as $REALTY):
            ...
            echo "<article class='box box25 imobi_single js-rel-to' id='{$realty_id}'>           
