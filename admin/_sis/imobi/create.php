...
if ($RealtyId):
    ...
    if ($Read->getResult()):
        ...
        $_SESSION['trigger_controll'] = "<b>OPSSS! {$Admin['user_name']}</b>, Você Tentou Editar Um Imóvel Que Não Existe ou Que Foi Removido Recentemente!";
...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a target="_blank" title="Ver Imóvel No Site" href="<?= BASE; ?>/imovel/<?= $realty_name; ?>" class="wc_view btn_header btn_darkblue icon-eye">Ver Imóvel No Site</a>
    </div>
</header>
    ...
    <form class="auto_save" name="realty_create" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box box70">
            ...
            <div class="panel_header default">
                <h2 class="icon-home3">Dados Sobre o Imóvel</h2>
            </div>
            ...
            <div class="panel">
                ...
                <div class="label_50">
                    ...
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="text" name="realty_price" class="mask-money" value="<?= ($realty_price ? number_format($realty_price, 2, ',', '.') : ''); ?>"/>
                    </label>
                </div>
        ...
        <div class="box box30">
            ...
            <div class="panel">
                ...
                <div class="wc_actions" style="text-align: center">
                    <button title="ATUALIZAR" name="public" value="1" class="btn_big btn_blue icon-share">ATUALIZAR <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.gif"/></button>
                    
                    <div class="switch__container">
                      <input value='1' id="switch-shadow" class="switch switch--shadow" type="checkbox" name='realty_status' <?= ($realty_status == 1 ? 'checked' : ''); ?>>
