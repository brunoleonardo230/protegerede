...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        $Pager->ReturnPage();
        echo Erro("<span class='al_center icon-notification'>Olá {$Admin['user_name']}, Ainda Não Existem Usuários Cadastrados. Comece Agora Mesmo Cadastrando Um Novo Usuário. Ou Aguarde Novos Clientes!</span>", E_USER_NOTICE);
    else:
        foreach ($Read->getResult() as $Users):
            ...
            echo "<article class='single_user box box25 al_center js-rel-to' id-'{$user_id}'>
                    ...
                    <div class='single_user_actions'>
                        <a class='btn btn_darkaquablue icon-user' href='dashboard.php?wc=users/create&id={$user_id}' title='Gerenciar Usuário'>Gerenciar Usuário</a>
                    </div>
                </article>";
        endforeach;
