...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a title="Recarregar Relatórios" href="dashboard.php?wc=reports/home" class="btn_header btn_darkaquablue icon-spinner11 icon-notext"></a>
    </div>
</header>
            ...
            <div class="wc_ead_chart_control">
                <div class="wc_ead_chart_range">
                    <form name="class_add" action="" method="post" enctype="multipart/form-data">
                        ...
                        </label><button title="Recarregar Relatórios" class="btn_header btn_darkaquablue icon-spinner11 icon-notext m_mobile"></button><img class="form_load m_top" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/microsoft.svg"/>
                    </form>
                </div><div class="wc_ead_chart_change">
                    <span class="icon icon-stats-bars icon-notext jwc_chart_change jwc_area_chart btn_header btn_green"></span>
                    <span class="icon icon-stats-bars2 icon-notext jwc_chart_change jwc_column_chart btn_header btn_orange"></span>
                    <span class="icon icon-stats-dots icon-notext jwc_chart_change jwc_line_chart btn_header btn_aquablue"></span>
                </div>
            </div>
