...
if ($OrderId):
    ...
    if ($Read->getResult()):
        ...
        $_SESSION['trigger_controll'] = "<b>OPSSS {$Admin['user_name']}!</b>, Você Tentou Editar Um Pedido Que Não Existe Ou Que Foi Removido Recentemente!";
    ...
    <form name="post_create" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box box30">
            ...
            <div class="panel">
                ...
                if (!$Read->getResult()):
                    echo Erro("<span class='icon-warning'>OPSSS:</span> Não Foi Possível Ler o Endereço de Envio Para Esse Pedido!", E_USER_ERROR);
                else:
    ...
    <article class="box box50">
        <div class="panel">
            <p>
                ...
                Significa Que Você Já Enviou o Pedido Para Entrega. Informe Uma Data de Postagem e Um Rastreio Para Avisar o Cliente Por E-mail!
            </p>
        </div>
    </article>
</div>