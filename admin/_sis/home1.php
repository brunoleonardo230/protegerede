...
<div class="dashboard_content">
    <div class="box box25">
        <div class="panel_header darkaquablue">
                <span>
                    <a href="javascript:void(0)" class="btn_header btn_aquablue icon-loop icon-notext"
                       id="loopDashboard"></a>
                </span>
            <h2 class="icon-earth">ONLINE AGORA:</h2>
        </div>
        <div class="panel_dash_darkaquablue dashboard_onlinenow">
            <?php
    ...
    <div class="box box25 dashboard_stats">
        <div class="panel_header darkaquablue_light">
            <h2 class="icon-stats-dots">HOJE:</h2>
        </div>
        <div class="panel_dash_darkaquablue_light">
            <?php
    ...
    <div class="box box25 dashboard_stats">
        <div class="panel_header aquablue_light">
            <h2 class="icon-stats-dots">TOTAL:</h2>
        </div>
        <div class="panel_dash_aquablue_light">
            <?php
                        ...
                        echo "
                                <article>
                                   ...
                                   <p>" . str_pad($ResultPosts + $ResultPdts, 4, 0, STR_PAD_LEFT) . " RESULTADOS</p>
                                    <p>
                                        <button title='Publicar' class='btn_header btn_darkaquablue icon-notext icon-checkmark wc_tooltip j_wc_action' data-callback='Search' data-callback-action='publish' data-value='$search_id'><span class='wc_tooltip_balloon'>Publicar</span></button>
                                        <button title='Excluir' class='btn_header btn_red icon-notext icon-bin wc_tooltip j_wc_action' data-callback='Search' data-callback-action='delete' data-value='$search_id'><span class='wc_tooltip_balloon'>Excluir</span></button>
                                    </p>
                                </article>
                            ";
                    endforeach;
