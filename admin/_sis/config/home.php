...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a title="Resetar Configurações!" href="dashboard.php?wc=config/home&wc_recet_config=true" class="btn_header btn_orange icon-warning wc_resetconfig">Resetar Configurações!</a>
    </div>
</header>
...
<div class="dashboard_content">
    ...
    if ($Read->getResult()):
        ...
        foreach ($Read->getResult() as $Config):
            ...
            echo "<div class='panel_header darkaquablue'><h2 class='icon-cog'>{$Config['conf_type']}</h2></div>";
