        ...
        <div class="tab_contents">
            <div class="wc_tab_target wc_active" id="panels">
                <div class="box box50">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_icon_action_subtitle"></a>
                        </span>
                ...
                <div class="box box50">    
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_icon_subtitle"></a>
                        </span>
                ...
                <div class="box box50">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_action_subtitle"></a>
                        </span>
                ...
                <div class="box box50">    
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_subtitle"></a>
                        </span>
                        <h2>Título do Painel</h2>
                        <p>Subtítulo do Painel</p>
                    </div>
                ...
                <div class="box box50">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_icon"></a>
                        </span>
                        <h2><span class="icon-command">Título do Painel</span></h2>
                    </div>
                    <div class="panel">
                ...
                <div class="box box50">    
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_header_default"></a>
                        </span>
                        <h2 class="icon-command">Título do Painel</h2>
                    </div>
                    <div class="panel">
                ...
                <div class="box box25">
                    <div class="panel_header bluelight">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Blue Light</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header blue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Blue</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkblue_light">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Blue Light</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkblue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Blue</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header green">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_success"></a>
                        </span>
                        <h2 class="icon-arrow-up">Green</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_alert"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Green</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header red">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_success"></a>
                        </span>
                        <h2 class="icon-arrow-up">Red</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkred">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_alert"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Red</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header yellow">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Yellow</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header orange">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Orange</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header purple">
                        ...
                        <h2 class="icon-arrow-up">Purple</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header purple_brown">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_alert"></a>
                        </span>
                        <h2 class="icon-arrow-up">Purple Brown</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header purple_yellow">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Purple Yellow</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header pink">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Pink</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header pink_radial">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_success"></a>
                        </span>
                        <h2 class="icon-arrow-up">Pink Radial</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header blue_radial">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_alert"></a>
                        </span>
                        <h2 class="icon-arrow-up">Blue Radial</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header light">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_info"></a>
                        </span>
                        <h2 class="icon-arrow-up">Light</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header dark">
                        ...
                        <h2 class="icon-arrow-up">Dark</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header green_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Green Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkgreen_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Green Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header blue_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Blue Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkblue_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Blue Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header yellow_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Yellow Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header orange_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Orange Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                            Maecenas sollicitudin sit amet ligula et pulvinar. Vestibulum metus lacus, porta non orci in, euismod semper quam. ta
                            Quisque tincidunt tortor non nibh sagittis porttitor.</p>
                    </div>
                </div>
                
                <div class="box box25">
                    <div class="panel_header red_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Red Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header darkred_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Red Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header pink_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Pink Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header purple_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Purple Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header grey_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Grey Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box25">
                    <div class="panel_header dark_solid">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_grey icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_dark icon-notext icon-embed2 wc_clip" rel="panel_header_warning"></a>
                        </span>
                        <h2 class="icon-arrow-up">Dark Sólido</h2>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at volutpat. 
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc maximus magna et venenatis pellentesque. 
                ...
                <div class="box box100">
                    ...
                    <div class="panel_footer">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_footer"></a>
                        </span>
                ...
                <div class="box box100">
                    ...
                    <div class="panel_footer_external">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="panel_footer_external"></a>
                        </span>
            ...
            <div class="wc_tab_target ds_none" id="boxes">
                ...
                <div class="box box100">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box100"></a>
                        </span>
                        <h2>BOX 100</h2>
                    </div>
                </div>
                ...
                <div class="box box50">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box50"></a>
                        </span>
                        <h2>BOX 50</h2>
                    </div>
                </div>
                ...
                <div class="box box33">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box33"></a>
                        </span>
                        <h2>BOX 33</h2>
                    </div>
                </div>
                ...
                <div class="box box25">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box25"></a>
                        </span>
                        <h2>BOX 25</h2>
                    </div>
                </div>
                ...
                <div class="box box30">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box30"></a>
                        </span>
                        <h2>BOX 30</h2>
                    </div>
                </div>
                ...
                <div class="box box70">
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_aquablue icon-notext icon-embed2 wc_clip" rel="box70"></a>
                        </span>
                        <h2>BOX 70</h2>
                    </div>
                </div>
            ...
            <div class="wc_tab_target ds_none" id="forms">
                <div class="box box100">
                    ...
                    <div class="panel_header darkaquablue">
                        <span>
                            <a href="javacript:void(0)" class="btn_header btn_aquablue icon-embed2 icon-notext wc_clip" rel="form"></a>
                        </span>
                    ...
                    <div class="panel">
                        <form>
                            ...
                            <label class="label">
                                <input type="submit" name="titulo" value="Enviar" class="btn btn_darkaquablue fl_right"/>
                            </label>
                        </form>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="wc_tab_target ds_none" id="buttons">
                <div class="box_content">
                    ...
                    <a href="javascript:void(0)" class="btn_header btn_green">Botão .btn_green</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkgreen">Botão .btn_darkgreen</a>
                    <a href="javascript:void(0)" class="btn_header btn_yellow">Botão .btn_yellow</a>
                    <a href="javascript:void(0)" class="btn_header btn_orange">Botão .btn_orange</a>
                    <a href="javascript:void(0)" class="btn_header btn_blue">Botão .btn_blue</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkblue">Botão .btn_darkblue</a>
                    <a href="javascript:void(0)" class="btn_header btn_red">Botão .btn_red</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkred">Botão .btn_darkred</a>
                    <a href="javascript:void(0)" class="btn_header btn_pink">Botão .btn_pink</a>
                    <a href="javascript:void(0)" class="btn_header btn_purple">Botão .btn_purple</a>
                    <a href="javascript:void(0)" class="btn_header btn_grey">Botão .btn_grey</a>
                    <a href="javascript:void(0)" class="btn_header btn_dark">Botão .btn_dark</a>
                    <a href="javascript:void(0)" class="btn_header btn_light">Botão .btn_light</a>
                    <a href="javascript:void(0)" class="btn_header btn_purple_brown">Botão .btn_purple_brown</a>
                    <a href="javascript:void(0)" class="btn_header btn_purple_yellow">Botão .btn_purple_yellow</a>
                    <a href="javascript:void(0)" class="btn_header btn_pink_radial">Botão .btn_pink_radial</a>
                    <a href="javascript:void(0)" class="btn_header btn_blue_radial">Botão .btn_blue_radial</a>
                    <a href="javascript:void(0)" class="btn_header btn_green_solid">Botão .btn_green_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkgreen_solid">Botão .btn_darkgreen_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_blue_solid">Botão .btn_blue_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkblue_solid">Botão .btn_darkblue_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_yellow_solid">Botão .btn_yellow_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_orange_solid">Botão .btn_orange_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_red_solid">Botão .btn_red_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkred_solid">Botão .btn_darkred_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_pink_solid">Botão .btn_pink_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_purple_solid">Botão .btn_purple_solid</a>
                    <a href="javascript:void(0)" class="btn_header btn_grey_solid">Botão .btn_grey_solid</a>
                     <a href="javascript:void(0)" class="btn_header btn_dark_solid">Botão .btn_dark_solid</a>

                    <p>Tamanho:</p>
                    <a href="javascript:void(0)" class="btn btn_aquablue">Botão Tamanho Padrão</a>
                    <a href="javascript:void(0)" class="btn btn_aquablue btn_small">Botão .btn_small</a>
                    <a href="javascript:void(0)" class="btn btn_aquablue btn_medium">Botão .btn_medium</a>
                    <a href="javascript:void(0)" class="btn btn_aquablue btn_large">Botão .btn_large</a>
                    <a href="javascript:void(0)" class="btn btn_aquablue btn_xlarge">Botão .btn_xlarge</a>
                    <a href="javascript:void(0)" class="btn btn_aquablue btn_xxlarge">Botão .btn_xxlarge</a>
                    <a href="javascript:void(0)" class="btn_big btn_aquablue btn_xxlarge">Botão .btn_big</a>

                    <p>Ícone:</p>
                    <a href="javascript:void(0)" class="btn_header btn_yellow icon-IcoMoon">Botão com Ícone .icon-IcoMoon</a>
                    <a href="javascript:void(0)" class="btn_header btn_yellow icon-IcoMoon icon-notext"></a> - icon-notext

                    <p>Borda:</p>
                    <a href="javascript:void(0)" class="btn_header btn_darkaquablue">Botão Borda Padrão</a>
                    <a href="javascript:void(0)" class="btn btn_darkaquablue rounded">Botão .rounded</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkaquablue icon-calendar icon-notext rounded"></a> - icon-calendar icon-notext rounded
                    
                    <p>Switch Checkbox:</p>
                    <div style="display: flex">
                        <!-- SWITCH iOS -->
                        <div class="switch__container" style="flex-basis: 100%; margin-top: 5px;">
                          <input value='1' id="switch-shadow" class="switch switch--shadow" type="checkbox" name='post_status'>
                          <label for="switch-shadow"></label>
                        </div>
                        
                        <!-- SWITCH PEQUENO -->
                        <div class="switch_content_box_header" style="flex-basis: 100%; margin-top: 5px;">
                            <input id="switch-id" class="wc_switch_input" type="checkbox"
                                   name="post_status">
                            <label for="switch-id" class="wc_switch_label">
                            </label>
                        </div> 
                    </div>
                </div>
...
<div class="panel_header">
    <span>
        <a href="javascript:void(0)" class="btn_header btn_darkaquablue icon-notext icon-link"></a>
    </span>
    <h2><span class="icon-command">Título do Painel</span></h2>
    <p class="subtitle">Subtítulo do Painel</p>
</div>
...
<div class="panel_header">
    <span>
        <a href="javascript:void(0)" class="btn_header icon-notext icon-link"></a>
    </span>
    <h2>Título do Painel</h2>
    <p>Subtítulo do Painel</p>
</div>
...
<textarea id="form" style="position: absolute; left: -10000px;">
    <form>
        ...
        <label class="label">
            <input type="submit" name="titulo" value="Enviar" class="btn_header btn_green fl_right"/>
        </label>
    </form>
</textarea>