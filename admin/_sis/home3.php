...
<div class="dashboard_content">
    ...
    <div class="box box25">
        <div class="panel_header darkblue">
            <span>
                <a href="javascript:void(0)" class="btn_header btn_blue icon-loop icon-notext" id="loopDashboard"></a>
            </span>
            <h2 class="icon-earth">ONLINE AGORA:</h2>
        </div>
        <div class="panel_dash_darkblue dashboard_onlinenow">
            <?php
    ...
    <div class="box box25">
        ...
        <div class="panel_dash_green dashboard_stats">
            <?php
                    ...
                    echo "
                        <article>
                            ...
                            <div class='info'>
                                ...
                                <h1><a target='_blank' href='" . BASE . "/imovel/{$realty_name}' title='Ver Imóvel' style='color: #000081'>{$realty_title}</a></h1>
                            </div>
                         </article>
                    ";
                endforeach;
