...
<div class="dashboard_content">
    ...
    <div class="box box25">
        <div class="panel_header orange">
            <span>
                <a href="javascript:void(0)" class="btn_transparent icon-loop icon-notext" id="loopDashboard"></a>
            </span>
            <h2 class="icon icon-stats-dots">Visitas:</h2>
        </div>
        <div class="panel_dash_orange dashboard_stats">
            <?php
    ...
    <div class="box box25">
        ...
        <div class="panel_dash_red dashboard_stats">
            <?php
        ...
        <div class="panel">
            ...
            if (!$Read->getResult()):
                ...
                foreach ($Read->getResult() as $Study):
                    ...
                    echo "<p><a class='btn btn_blue' href='dashboard.php?wc=teach/students_gerent&id={$user_id}' title='{$user_name} {$user_lastname}'><b>VER ALUN" . ($user_genre == 2 ? 'A' : 'O') . "</b></a></p>";
                    echo "</article>";
                endforeach;
            endif;
            ?>
                        ...
                        echo "
                            <article>
                               ...
                               <p>" . str_pad($ResultPosts + $ResultPdts, 4, 0, STR_PAD_LEFT) . " RESULTADOS</p>
                                <p>
                                    <button title='Publicar' class='btn-header btn_darkblue icon-notext icon-checkmark wc_tooltip j_wc_action' data-callback='Search' data-callback-action='publish' data-value='$search_id'><span class='wc_tooltip_balloon'>Publicar</span></button>
                                    <button title='Excluir' class='btn_header btn_red icon-notext icon-cross wc_tooltip j_wc_action' data-callback='Search' data-callback-action='delete' data-value='$search_id'><span class='wc_tooltip_balloon'>Excluir</span></button>
                                </p>
                            </article>
                        ";
                    endforeach;
