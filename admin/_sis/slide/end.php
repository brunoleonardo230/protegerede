...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <div class="dashboard_header_title">
        <h1 class="icon-camera">Slides Inativos</h1>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        $Pager->ReturnPage();
        Erro("<span class='al_center icon-notification'>{$Admin['user_name']}, Não Existem Slides Inativos Em Seu Site. Os Destaques Expirados Ou Fora de Data São Apresentados Aqui!</span>",  E_USER_NOTICE);
    else:
