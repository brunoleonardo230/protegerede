...
<form name="account_form" autocomplete="off" action="" method="post" enctype="multipart/form-data">
    <div class="account_form_fields">
        ...
        <label>
            <span>* Sobrenome:</span>
            <input name="user_lastname" value="<?= $_SESSION['userLogin']['user_lastname']; ?>" type="text" placeholder="Sobrenome:" required/>
        </label>
        ...
        <label>
            ...
            <?php else: ?>
                <input class="formCpf" name="user_document" value="" type="text" placeholder="CPF:"/>
            <?php endif; ?>
        </label>
        ...
        <label>
            <span>Telefone:</span>
            <input class="formPhone" name="user_telephone" value="<?= $_SESSION['userLogin']['user_telephone']; ?>" type="text" placeholder="Telefone:"/>
        </label>

        <label>
            <span>Celular:</span>
            <input class="formPhone" name="user_cell" value="<?= $_SESSION['userLogin']['user_cell']; ?>" type="text" placeholder="Celular:"/>
        </label>
