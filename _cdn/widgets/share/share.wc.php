...
echo "<li class='workcontrol_socialshare_item workcontrol_socialshare_whatsapp'><a class='whatsapp' data-text='{$WcShareText}' data-link='{$WcShareLink}'><img alt='{$ShareIconText}' title='{$ShareIconText}' src='" . BASE . "/_cdn/widgets/share/icons/whatsapp.png'/></a></li>";
