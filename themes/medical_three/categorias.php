                ...
                <div itemscope itemtype="http://schema.org/Blog" class="row">
                    ...
                    <div class="content-area col-md-8 col-sm-8 col-xs-12">
                        ...
                        $Read->FullRead(
                            ...
                            . "LIMIT :limit OFFSET :offset ", "s=1&limit={$Pager->getLimit()}&offset={$Pager->getOffset()}&ct={$category_id}"
                        );
                        if (!$Read->getResult()):
                            echo Erro("Ainda Não Existem Posts Cadastrados. Por Favor, Volte Mais Tarde! :)", E_USER_NOTICE);
                        else:
